...
double badrandomdouble(){ // not exactly the most accurate
...
int main(void){
	...
	srand(time(NULL)); // use current time as random number seed
	hs.randomdouble = &badrandomdouble; // use crude random number generator
